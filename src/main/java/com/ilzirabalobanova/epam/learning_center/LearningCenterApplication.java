...
public class LearningCenterApplication {
    ...
    public static void main(String[] args) {
        ...
        JDBCStudentRepository jdbcStudentRepository = context.getBean(JDBCStudentRepository.class);
        jdbcStudentRepository.updateStudent(1, new Student("Petr", "", "", "", null, false, null, null));
