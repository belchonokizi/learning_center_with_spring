...
class StudentRepositoryTest {
    ...
    private final Student student1 = new Student(1, "Ivan", "Gorin", "89120253064", "sdfghjk", List.of(new Program(1)));
    private final Student student2 = new Student(2, "Anna", "Grushina", "89240266064", "f",  List.of(new Program(2)));
    private final Student student3 = new Student(3, "Elena", "Sovina", "89360253048", "fff", List.of(new Program(3)));
    private final Student student4 = new Student( "Boris", "Sidorov", "89120183064", "boris",  List.of(new Program(4)));
